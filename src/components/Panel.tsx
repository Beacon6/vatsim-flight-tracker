      ...
      >
        ...
        <Offcanvas.Body className='panel-body'>
          ...
          <Container>
            <Row>
              <Col className='panel-info'>
                Altitude (MSL): {selectedFlight?.pilot.altitude} feet
              </Col>
              <Col className='panel-info'>
                Speed (GS): {selectedFlight?.pilot.groundspeed} knots
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col className='panel-info'>
                Flight rules:{' '}
                {selectedFlight?.pilot.flight_plan?.flight_rules === 'I' ? 'IFR' : 'VFR'}
              </Col>
          ...
          <Accordion>
            ...
            <Accordion.Item eventKey='1'>
              ...
              <Accordion.Body>
                {selectedFlight?.pilot.flight_plan?.remarks
                  ? selectedFlight?.pilot.flight_plan?.remarks
                  : 'No remarks'}
              </Accordion.Body>
            </Accordion.Item>
